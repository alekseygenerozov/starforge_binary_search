...
for ii in range(start, end, 1):
        bash_command("python3 find_multiples_new2.py --halo_mass_file M2e4halo_masses_sing_npTrue_c0.5 --ngrid 8 --snap_base {0} {1} --tides_factor {2}".format(snap_base, ii, 8.0))
